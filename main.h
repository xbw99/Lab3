...
#line 42 "/ECEnet/Apps1/sce/latest/inc/bits/huge_val.h"
typedef union { unsigned char __c[8]; double __d; } __huge_val_t;

#line 40 "/ECEnet/Apps1/sce/latest/inc/bits/huge_valf.h"
typedef union { unsigned char __c[4]; float __f; } __huge_valf_t;

#line 54 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef union {
    char __size[56];
    long int __align; }
    pthread_attr_t;
...
#line 77 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef union {

#line 101 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
...
#line 116 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef union {

#line 133 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
...
#line 162 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef union {

#line 179 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
...
#line 198 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
    char __size[56];
    long int __align; }
    pthread_rwlock_t;
...
#line 218 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef union {
    char __size[32];
    long int __align; }
    pthread_barrier_t;
...
#line 294 "/usr/include/libio.h"
    long int _offset;

#line 303 "/usr/include/libio.h"
    void *__pad1;
    void *__pad2;
    void *__pad3;
    void *__pad4;
...
#line 65 "/usr/include/sys/select.h"
typedef struct {

#line 72 "/usr/include/sys/select.h"
...
#line 9 "./image_queue.sc"
typedef unsigned char img[76800];

#line 50 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef unsigned long int pthread_t;

#line 65 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef struct __pthread_internal_list __pthread_list_t;

#line 151 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
...
#line 212 "/ECEnet/Apps1/sce/latest/inc/bits/pthreadtypes.h"
typedef volatile int pthread_spinlock_t;

#line 28 "/usr/include/bits/mathdef.h"
...
#line 48 "/usr/include/sys/select.h"
...
#line 162 "/usr/include/sys/types.h"
typedef char int8_t;
...
#line 173 "/usr/include/sys/types.h"
...
#line 40 "/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include/stdarg.h"
typedef void *__gnuc_va_list;

#line 147 "/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include/stddef.h"
typedef long int ptrdiff_t;

#line 212 "/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include/stddef.h"
...
/* note c_image_queue._SCE_STANDARD_LIB = { "c_queue","image","img" }; */

#line 606 "main.h"
class i_image_receiver;

#line 10 "./image_queue.sc"
/* note i_image_receiver._SCE_STANDARD_LIB = { "i_receiver","image","img" }; */

#line 612 "main.h"
class i_image_sender;

#line 10 "./image_queue.sc"
/* note i_image_sender._SCE_STANDARD_LIB = { "i_sender","image","img" }; */

#line 618 "main.h"
class i_image_tranceiver;

#line 10 "./image_queue.sc"
/* note i_image_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","image","img" }; */
...
#line 641 "main.h"
    virtual ~i_image_receiver(void){};

#line 10 "./image_queue.sc"
    virtual void receive(unsigned char (*)[76800]) = 0;
private:
};
...
#line 655 "main.h"
    virtual ~i_image_sender(void){};

#line 10 "./image_queue.sc"
    virtual void send(unsigned char [76800]) = 0;
private:
};
...
#line 669 "main.h"
    virtual ~i_image_tranceiver(void){};

#line 10 "./image_queue.sc"
    virtual void receive(unsigned char (*)[76800]) = 0; virtual void send(unsigned char [76800]) = 0;
private:
};
...
#line 10 "./image_queue.sc"
class c_image_queue : public _specc::channel, public i_image_sender, public i_image_receiver, public i_image_tranceiver
{
private:
...
#line 688 "main.h"
    c_image_queue(const unsigned long int (&size),  const char *_InstanceName, _specc::class_type *_Parent);
    virtual ~c_image_queue(void);
    void cleanup(void);
    void receive(unsigned char (*)[76800]);
    void send(unsigned char [76800]);
    void setup(void);
private:

#line 10 "./image_queue.sc"
    unsigned char (*buffer)[76800]; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};
...
#line 710 "main.h"
    Monitor(unsigned int _idcnt, i_image_receiver (&ch),  const char *_InstanceName, _specc::class_type *_Parent);
...
#line 14 "./platform.sc"
    i_image_receiver (&ch1); i_image_sender (&ch2);
public:

#line 745 "main.h"
    DataIn(unsigned int _idcnt, i_image_receiver (&ch1), i_image_sender (&ch2),  const char *_InstanceName, _specc::class_type *_Parent);
    virtual ~DataIn(void);
    void main(void);
private:
...
#line 764 "main.h"
    DataOut(unsigned int _idcnt, i_image_receiver (&ch1), i_image_sender (&ch2),  const char *_InstanceName, _specc::class_type *_Parent);
...
#line 786 "main.h"
    DUT(unsigned int _idcnt, i_image_receiver (&ch1), i_image_sender (&ch2),  const char *_InstanceName, _specc::class_type *_Parent);
    virtual ~DUT(void);
    void main(void);
private:
...
#line 49 "./platform.sc"
    i_image_receiver (&toPlatform); i_image_sender (&outPlatform);
public:

#line 805 "main.h"
    Platform(unsigned int _idcnt, i_image_receiver (&toPlatform), i_image_sender (&outPlatform),  const char *_InstanceName, _specc::class_type *_Parent);
...
#line 6 "./stimulus.sc"
    i_image_sender (&ch); char *(&infilename);
public:

#line 835 "main.h"
    Stimulus(unsigned int _idcnt, i_image_sender (&ch), char *(&infilename),  const char *_InstanceName, _specc::class_type *_Parent);
...
#line 857 "main.h"
    Main(unsigned int _idcnt,  const char *_InstanceName, _specc::class_type *_Parent);
    virtual ~Main(void);
    int main(int, char *[]);
private:
...
#line 88 "/usr/include/bits/mathcalls.h"
...
#line 300 "/usr/include/math.h"
extern _LIB_VERSION_TYPE _LIB_VERSION;

#line 326 "/usr/include/math.h"
...
extern "C" int mbtowc(long int *, const char *, unsigned long int);
...
extern "C" unsigned long int mbstowcs(long int *, const char *, unsigned long int);


extern "C" unsigned long int wcstombs(char *, const long int *, unsigned long int);

#line 884 "/usr/include/stdlib.h"
extern "C" int rpmatch(const char *);

#line 947 "/usr/include/stdlib.h"
